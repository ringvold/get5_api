defmodule Get5ApiWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use Get5ApiWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Get5Api.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = Get5Api.Accounts.generate_user_session_token(user)
