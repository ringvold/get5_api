defmodule Get5ApiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Get5ApiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Get5ApiWeb.Gettext, "errors", msg, opts)
    end
  end
