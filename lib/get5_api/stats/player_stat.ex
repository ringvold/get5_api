defmodule Get5Api.Stats.PlayerStats do
  ...
  def changeset(player_stats, attrs) do
    player_stats
    |> cast(attrs, [:steam_id, :kill, :deaths, :assists, :flash_assists, :team_kills, :suicides, :damage, :utility_damage, :enemies_flashed, :friendlies_flashed, :knife_kills, :headshot_kills, :rounds_played, :bomb_defuses, :bomb_plants, :"1k", :"2k", :"3k", :"4k", :"5k", :"1v1", :"1v2", :"1v3", :"1v4", :"1v5", :first_kills_t, :first_kills_ct, :first_deaths_t, :first_deaths_ct, :trade_kills, :kast, :score, :mvp])
    |> cast_assoc(:match)
